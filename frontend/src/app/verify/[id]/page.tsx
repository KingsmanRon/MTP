...
export async function generateMetadata({
  ...
  const description = `Independently verify this AI agent action. Receipt state, policy hash, and anchor status are checked in real time. ${verdict} — ${record.agent_name}, ${record.action_type}. ${sigStatus}. ${chainStatus}.`;
