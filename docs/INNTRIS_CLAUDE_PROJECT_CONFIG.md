...
**You are working exclusively in `Inntris/agent-orchestrator-guardrails`.** This is the full
...
- Work only in `Inntris/agent-orchestrator-guardrails` — never reference `github.com/Inntris`
...
*Commit as `docs/verify-page-spec.md` in `Inntris/agent-orchestrator-guardrails`*
